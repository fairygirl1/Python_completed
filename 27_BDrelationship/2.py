...
employees = [
    Employee(name="John Doe", experience=3, positions=[positions[0], positions[1]]),
    Employee(name="Jane Smith", experience=7, positions=[positions[1], positions[2]]),
    Employee(name="Michael Johnson", experience=5, positions=[positions[2], positions[3]]),
    Employee(name="Emily Davis", experience=2, positions=[positions[3], positions[0]])
]
